...
export const metadata: Metadata = {
  ...
  title: "Cobra AI - Home",
  description:
    "Cobra AI 2.0 Home Page— Manage your projects, generate code with AI assistance, monitor real-time development, and boost your productivity with intelligent full-stack tools.",
  authors: [
