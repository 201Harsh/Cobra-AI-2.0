...
const CreatorPlusService = require("../services/creator-ai-plus.service");
...
module.exports.GenerateAdvancedWebsite = async (req, res) => {
  try {
    const { prompt, name, type, theme } = req.body;
    ...
    const Response = await CreatorPlusService({
      prompt,
      name,
      type,
      theme,
